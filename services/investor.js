...
const { getStartByID } = require('./startup');
...
// allinvestor=getAllInvestor()
// for(let i=0 ; i< allinvestor.length;i++){
//     console.log(allinvestor[i]["investedAmt"]+123)
// }
console.log(getInvestorByID(160)["investedAmt"]+123)

console.log(getStartByID(3)["fundsRaised"]-123)

exports.getAllInvestor=getAllInvestor
